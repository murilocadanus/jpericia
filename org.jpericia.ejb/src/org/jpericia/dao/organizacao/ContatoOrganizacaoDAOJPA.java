...
public class ContatoOrganizacaoDAOJPA extends AbstractDAO implements ContatoOrganizacaoDAO {
	
	private static Logger logger = Logger.getLogger(ContatoOrganizacaoDAOJPA.class);
	...
	public void inserir(ContatoOrganizacao contatoOrganizacao) throws DAOException {
		...
		try{
			...
			manager.persist(contatoOrganizacao);
			manager.flush();
		}catch(Exception e){
	...
	public void atualizar(ContatoOrganizacao contatoOrganizacao) throws DAOException {
		...
		try{
			manager = PersistenceUtil.currentEntityManager();
			ContatoOrganizacao contatoOrganizacaoManaged = manager.merge(contatoOrganizacao);
			
			manager.persist(contatoOrganizacaoManaged);
			manager.flush();
		}catch(Exception e){
			throw new DAOException("Erro salvar Cliente", e);
		}
	...
	public void remover(ContatoOrganizacao contatoOrganizacao) throws DAOException {
		...
		try{
			...
			manager.remove(contatoOrganizacaoManaged);
			manager.flush();
		}catch(Exception e){
			throw new DAOException("Erro salvar Cliente", e);
		}
	...
	public ArrayList<AbstractEntity> pesquisar() throws DAOException {
		...
		try{
	        ...
	        queryStr.append("from ContatoOrganizacao p order by nome");
