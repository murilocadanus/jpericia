...
public class TipoOrganizacaoDAOJPA extends AbstractDAO implements TipoOrganizacaoDAO {
	
	private static Logger logger = Logger.getLogger(TipoOrganizacaoDAOJPA.class);
	...
	public void inserir(TipoOrganizacao tipoOrganizacao) throws DAOException {
		...
		try{
			...
			manager.persist(tipoOrganizacao);
			manager.flush();
		}catch(Exception e){
	...
	public void atualizar(TipoOrganizacao tipoOrganizacao) throws DAOException {
		...
		try{
			manager = PersistenceUtil.currentEntityManager();
			TipoOrganizacao tipoOrganizacaoManaged = manager.merge(tipoOrganizacao);
			
			manager.persist(tipoOrganizacaoManaged);
			manager.flush();
		}catch(Exception e){
			throw new DAOException("Erro salvar Cliente", e);
		}
	...
	public void remover(TipoOrganizacao tipoOrganizacao) throws DAOException {
		...
		try{
			...
			manager.remove(tipoOrganizacaoManaged);
			manager.flush();
		}catch(Exception e){
			throw new DAOException("Erro salvar Cliente", e);
		}
	...
	public ArrayList<AbstractEntity> pesquisar() throws DAOException {
		logger.debug("Entrou TipoOrganizacaoDAOJPA");
		EntityManager manager = null;
		try{
			manager = PersistenceUtil.currentEntityManager();
			StringBuffer queryStr = new StringBuffer();
			
	        queryStr.append("from TipoOrganizacao p order by nome");
			...
			throw new DAOException("Erro salvar TipoOrganizacaoDAOJPA", e);
		}
	}
