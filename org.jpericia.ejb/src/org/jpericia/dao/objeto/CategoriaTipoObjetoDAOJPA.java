...
public class CategoriaTipoObjetoDAOJPA extends AbstractDAO implements CategoriaTipoObjetoDAO {
	
	private static Logger logger = Logger.getLogger(CategoriaTipoObjetoDAOJPA.class); 
	
	//@Override
	public void inserir(CategoriaTipoObjeto categoriaTipoObjeto) throws DAOException {
		logger.debug("Entrou ClienteDAOJPA");
		EntityManager manager = null;
		try{
			manager = PersistenceUtil.currentEntityManager();
			manager.persist(categoriaTipoObjeto);
			manager.flush();
		}catch(Exception e){
	...
	public void atualizar(CategoriaTipoObjeto categoriaTipoObjeto) throws DAOException {
		logger.debug("Entrou ClienteDAOJPA");
		EntityManager manager = null;
		try{
			manager = PersistenceUtil.currentEntityManager();
			CategoriaTipoObjeto categoriaTipoObjetoManaged = manager.merge(categoriaTipoObjeto);
			
			//manager.refresh(categoriaTipoObjetoManaged);
			manager.persist(categoriaTipoObjetoManaged);
			manager.flush();
		}catch(Exception e){
			throw new DAOException("Erro salvar Cliente", e);
		}
	...
	public void remover(CategoriaTipoObjeto categoriaTipoObjeto) throws DAOException {
		...
		try{
			...
			manager.remove(categoriaTipoObjetoManaged);
			manager.flush();
		}catch(Exception e){
			throw new DAOException("Erro salvar Cliente", e);
		}
	...
	public ArrayList<AbstractEntity> pesquisar() throws DAOException {
		...
		try{		
	        ...
	        queryStr.append("from CategoriaTipoObjeto p order by nome");
