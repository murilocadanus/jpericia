...
public interface AnaliseDAO {
	...
	public void inserir(Analise tipoAnalise) throws DAOException;
	
	public void atualizar(Analise tipoAnalise) throws DAOException;
	
	public void remover(Analise tipoAnalise) throws DAOException;
