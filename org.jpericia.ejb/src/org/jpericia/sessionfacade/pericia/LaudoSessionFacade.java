...
import org.jpericia.applicationservice.pericia.LaudoAS;
...
public class LaudoSessionFacade extends AbstractSessionFacade implements LaudoSessionFacadeRemote {
	
	private static Logger logger = Logger.getLogger(LaudoSessionFacade.class);
	
	@TransactionAttribute(NEVER)
	public void inserir(Laudo laudo) throws SessionFacadeException {
		try {
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			LaudoAS.getInstance().inserir(laudo);
	...
	public void atualizar(Laudo laudo) throws SessionFacadeException {
		try {
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			LaudoAS.getInstance().atualizar(laudo);
			logger.debug("Fim " + this.getClass().getName() + ".salvar()");
		} catch (ApplicationServiceException ase) {
			logger.error(this.getClass().getName() + ".salvar()");
			throw new SessionFacadeException("Erro salvando Cliente", ase);
	...
	public void remover(Laudo laudo) throws SessionFacadeException {
		try {
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			LaudoAS.getInstance().remover(laudo);
			logger.debug("Fim " + this.getClass().getName() + ".salvar()");
		} catch (ApplicationServiceException ase) {
			logger.error(this.getClass().getName() + ".salvar()");
			throw new SessionFacadeException("Erro salvando Cliente", ase);
	...
	public ArrayList<AbstractEntity> pesquisar() throws SessionFacadeException {
		try {
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			ArrayList<AbstractEntity> pesquisa = LaudoAS.getInstance().pesquisar();
			logger.debug("Fim " + this.getClass().getName() + ".salvar()");
			return pesquisa;
		} catch (ApplicationServiceException ase) {
			logger.error(this.getClass().getName() + ".salvar()");
