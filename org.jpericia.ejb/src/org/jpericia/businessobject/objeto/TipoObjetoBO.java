...
import org.jpericia.dao.objeto.TipoObjetoDAO;
...
public class TipoObjetoBO extends AbstractBusinessObject {
	
	private static Logger logger = Logger.getLogger(TipoObjetoBO.class);
	
	private static TipoObjetoBO me;

	private TipoObjetoBO() {
	}
	 ...
	 * @return ClienteAS
	 */
	public static TipoObjetoBO getInstance() {
		if (me == null) {
			loadInstance();
		}
		return me;
	 ...
	 */
	public void inserir(TipoObjeto tipoObjeto) throws BusinessObjectException{
		try{
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			JPericiaDAOFactory factory = this.getDaoFactory();
			TipoObjetoDAO tipoObjetoDAO = (TipoObjetoDAO)factory.getDao(TipoObjetoDAO.class);
			tipoObjetoDAO.inserir(tipoObjeto);
	 ...
	 * @throws ApplicationServiceException
	 */
	public void atualizar(TipoObjeto tipoObjeto) throws BusinessObjectException{
		try{
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			JPericiaDAOFactory factory = this.getDaoFactory();
			TipoObjetoDAO tipoObjetoDAO = (TipoObjetoDAO)factory.getDao(TipoObjetoDAO.class);
			tipoObjetoDAO.atualizar(tipoObjeto);
			logger.debug("Fim " + this.getClass().getName() + ".salvar()");
		}catch (JPericiaDAOFactoryException tdfe) {
			logger.fatal(tdfe.getMessage(), tdfe);
			throw new BusinessObjectException("Erro salvando Cliente", tdfe);
	 ...
	 * @throws ApplicationServiceException
	 */
	public void remover(TipoObjeto tipoObjeto) throws BusinessObjectException{
		try{
			logger.debug("Inicio " + this.getClass().getName() + ".salvar()");
			JPericiaDAOFactory factory = this.getDaoFactory();
			TipoObjetoDAO tipoObjetoDAO = (TipoObjetoDAO)factory.getDao(TipoObjetoDAO.class);
			tipoObjetoDAO.remover(tipoObjeto);
			logger.debug("Fim " + this.getClass().getName() + ".salvar()");
		}catch (JPericiaDAOFactoryException tdfe) {
			logger.fatal(tdfe.getMessage(), tdfe);
			throw new BusinessObjectException("Erro salvando Cliente", tdfe);
	...
	public ArrayList<AbstractEntity> pesquisar() throws BusinessObjectException{
		try{
			...
			JPericiaDAOFactory factory = this.getDaoFactory();
			TipoObjetoDAO tipoObjetoDAO = (TipoObjetoDAO)factory.getDao(TipoObjetoDAO.class);
			ArrayList<AbstractEntity> pesquisa = tipoObjetoDAO.pesquisar();
			logger.debug("Fim " + this.getClass().getName() + ".salvar()");
			return pesquisa;
		}catch (JPericiaDAOFactoryException tdfe) {
			logger.fatal(tdfe.getMessage(), tdfe);
	...
	public PaginaTO consultar(CriterioPesquisaTO criterios) throws BusinessObjectException{
		...
		try{
			...
			JPericiaDAOFactory factory = this.getDaoFactory();
			TipoObjetoDAO tipoObjetoDAO = (TipoObjetoDAO)factory.getDao(TipoObjetoDAO.class);
			retorno = tipoObjetoDAO.consultar(criterios);
